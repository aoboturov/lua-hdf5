...
function test.const_int_type_scalar(decl)
  assert(cdecl.declare(decl:type():name()) == "typedef const int const_int_type")
  assert(cdecl.declare(decl:type()) == "const int")
  ...
  assert(cdecl.declare(decl, function(node)
    return node:name():value()
  end) == "const_int_type const_int_type_scalar")
end
...
function test.volatile_const_int_type_scalar(decl)
  ...
  assert(cdecl.declare(decl:type(), function(node)
    return node:name():value()
  end) == "volatile const_int_type")
  assert(cdecl.declare(decl, function(node)
    return node:name():value()
  end) == "volatile const_int_type volatile_const_int_type_scalar")
end
...
function test.const_unsigned_long_type_scalar(decl)
  assert(cdecl.declare(decl:type():name()) == "typedef const long unsigned int const_unsigned_long_type")
  ...
  assert(cdecl.declare(decl:type():name(), function(node)
    return node:name():value()
  end) == "typedef const long unsigned int const_unsigned_long_type")
  assert(cdecl.declare(decl:type(), function(node)
    return node:name():value()
  end) == "const_unsigned_long_type")
  assert(cdecl.declare(decl, function(node)
    return node:name():value()
  end) == "const_unsigned_long_type const_unsigned_long_type_scalar")
end
...
function test.volatile_const_unsigned_long_type_scalar(decl)
  ...
  assert(cdecl.declare(decl:type(), function(node)
    return node:name():value()
  end) == "volatile const_unsigned_long_type")
  assert(cdecl.declare(decl, function(node)
    return node:name():value()
  end) == "volatile const_unsigned_long_type volatile_const_unsigned_long_type_scalar")
end
