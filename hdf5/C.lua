...
long int H5Iget_name(hid_t, char *, size_t);
...
long int H5Eget_class_name(hid_t, char *, size_t);
...
long int H5Eget_msg(hid_t, H5E_type_t *, char *, size_t);
long int H5Eget_num(hid_t);
...
long int H5Fget_obj_count(hid_t, unsigned int);
long int H5Fget_obj_ids(hid_t, unsigned int, size_t, hid_t *);
...
long int H5Fget_file_image(hid_t, void *, size_t);
...
long int H5Fget_name(hid_t, char *, size_t);
...
typedef long int (*H5L_query_func_t)(const char *, const void *, size_t, void *, size_t);
...
long int H5Lget_name_by_idx(hid_t, const char *, H5_index_t, H5_iter_order_t, hsize_t, char *, size_t, hid_t);
...
long int H5Oget_comment(hid_t, char *, size_t);
long int H5Oget_comment_by_name(hid_t, const char *, char *, size_t, hid_t);
...
long int H5Aget_name(hid_t, size_t, char *);
long int H5Aget_name_by_idx(hid_t, const char *, H5_index_t, H5_iter_order_t, hsize_t, char *, size_t, hid_t);
...
long int H5Rget_name(hid_t, H5R_type_t, const void *, char *, size_t);
...
long int H5Pget_data_transform(hid_t, char *, size_t);
...
long int H5Pget_elink_prefix(hid_t, char *, size_t);
